...
//
//    // RatingService ratingService = new RatingServiceImpl(ratingRepositoryMock, userRepositoryMock);
//
...
//    {
//        Optional<Rating> optionalRating = ratingService.findByBookAndUser(book.getId(), user.getId());
//
//        Mockito.verify(ratingRepositoryMock, times(1)).
//                findRatingByBook_IdAndUser_Id(book.getId(), user.getId());
//    } */
//}
